#let cover(
  ...
  text(30pt, weight: "bold")[Specifica Tecnica\ ]
  ...
  set page(
    ...
    header: [
      ...
      #table(
        ...
        table.cell(rowspan: 3, align: right + horizon)[#image(logo, height: 130%)],
        table.cell(align: left, inset: (x: 0%))[2075539], table.cell(align: right)[degli Studi],
        table.cell(align: left, inset: (x: 0%))[Piano di Lavoro stage c/o KIREY Srl],
        table.cell(
          align: right,
        )[di Padova],
      )
