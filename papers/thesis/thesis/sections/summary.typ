...
La soluzione adottata consiste nell'implementazione di un Web Application Firewall (WAF), progettato per analizzare le richieste inviate dal client al server. 
