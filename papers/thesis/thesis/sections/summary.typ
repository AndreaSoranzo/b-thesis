...
La soluzione adottata consiste nell'implementazione di un #glos("WAF"), progettato per analizzare le richieste inviate dal client al server. 
Attraverso un set di regole predefinite, il #glos("WAF") è in grado di identificare e bloccare le richieste sospette.
...
informatiche, tramite la creazione di una micro-rete dedicata a rendere più sicura la comunicazione client-server.