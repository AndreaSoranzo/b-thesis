...
- *Management Network (blu):* parte della rete ha protagonista l'admin di F5 il quale ha la possibilità di connettersi direttamente dal applicativo F5 e configurarlo a suo piacimento.
...
NAT per ciascuna di esse, a fini di praticità. Questa soluzione ha facilitato notevolmente
